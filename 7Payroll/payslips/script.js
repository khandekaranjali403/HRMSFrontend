...
submitAddBadge.addEventListener("click", (e) => {
  ...
  let netsalary=document.getElementById('addnetsalary');
  let details=document.getElementById('adddetails');
  ...
  <td>Send
              <a href="https://drive.google.com/">
                <img src="send-message.png" alt="" href="https://drive.google.com/" height="15px" width="15px">
              </a>
            </td>
